...
cp -r ./vendor/p2made/yii2-a4e/common/* ./common/
cp -r ./vendor/p2made/yii2-a4e/backend/* ./backend/
cp -r ./vendor/p2made/yii2-a4e/frontend/* ./frontend/
cp -r ./vendor/p2made/yii2-a4e/environments/* ./environments/
```
